        ...
        <div class="container">
                                    ...
                                    <div class='item_home col-12 col-sm-4 <?php echo $classItem ?>'>
                                        ...
                                        <?php if (get_sub_field('imagen_item_home')): ?>
                                            <div class='warp__imagen'>
                                                <img class="img-fluid"
                                                     src="<?php echo get_sub_field('imagen_item_home')['url'] ?>"
                                        ...
                                        <?php if (get_sub_field('boton_item_home')): ?>
                                            <div class='warp__boton'>
                                                <a href='<?php the_sub_field('boton_item_home') ?>'>

                                                    <?php if( get_sub_field( 'titulo_boton_item_home' ) ): ?>
                                                        <h2 class='titulo_boton_item_home'>
                                                            <?php the_sub_field( 'titulo_boton_item_home' ) ?>
                                                        </h2><!-- .titulo_boton_item_home -->
                                                    <?php endif; ?>
            ...
            <article class="home__testimonials">
                <?php if (get_field('testimonios_items')): ?>
                    <div class='items_home'>
                        <div class='row descripcionSlier'>
